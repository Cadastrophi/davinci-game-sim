  ...
  shell.innerHTML = `
    <aside class="training-rail" aria-label="Training controls">
      ...
      <div class="training-setup">
        ...
        <label class="training-field">Input source<select data-source><option value="mock">Mock · interactive</option><option value="replay">Replay · recorded / demo</option><option value="serial">Serial · physical controller</option></select></label>
