...
| --- | --- | --- | --- | --- | --- | --- |
| Bootstrap | Justin | Codex | `main` (initialization only) | Governance, docs, local skills, reference submodule | Merged by initial repository creation | 2026-09-13 |
| Pending issue: simulator discovery brief | Justin | Codex | `justin/simulator-discovery-brief` | `CONTEXT.md`, product intent, ADR 0002, discovery specification, review handoff | review | 2026-09-13 |
